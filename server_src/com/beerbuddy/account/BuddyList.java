 ...
 *
 */
@WebServlet("/buddyList")
public class BuddyList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String buddy = request.getParameter("buddyid");
		...
		if (valid) {
			...
			try {
				...
				statement = connection
				        .prepareStatement("SELECT buddy.username, buddy.id_Buddy, buddy.name FROM buddylist "
				                + "LEFT JOIN buddy ON id_Buddy = id_Buddy2 WHERE id_Buddy1 = " + buddy);
