...
public class TestTryANewBeer extends Mockito {

	@Test
	public void TestTryANewBeer_BlankName() throws Exception {
		...
		new TryANewBeer().doGet(request, response);
	...
	@Test
	public void TestTryANewBeer_validName() throws Exception {
		HttpServletRequest request = mock(HttpServletRequest.class);
		HttpServletResponse response = mock(HttpServletResponse.class);
	...
	@Test
	public void TestTryANewBeer_WithWrongCharacters() throws Exception {
		HttpServletRequest request = mock(HttpServletRequest.class);
		HttpServletResponse response = mock(HttpServletResponse.class);
