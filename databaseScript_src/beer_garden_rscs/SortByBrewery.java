...
public class SortByBrewery {
	...
	/**
	 * Private constructor. This class defines a utility method
	 */
	private SortByBrewery() {
	...
	public static void sortBeersByBrewery() {
		...
		if (BeerInformationScavenger.beers.isEmpty()) {
			throw new UnsupportedOperationException("Cannot sort beers by brewery ~~~> beers ArrayList is empty");
		}
