...
public class BeerInformationScavenger {
	...
	public static void gatherBeerInformation() {
		WebConnection.createDoc();	// creates the JSoup document from the WebConnection class
		...
		// failed to create for reasons described in err lines
		else {
			err.println("unable to connect to Tap Hunter ~~~> could not create Jsoup Document related to the page");
			return;
		}
	}
	...
	private static ArrayList<String> grabBeerInfomation(String barArea, String beerType, Element tap) {
		assert !barArea.equals(null);
		assert !beerType.equals(null);
		assert !tap.equals(null);
	...
	/**
	 * This subroutine grabs all of the web menu elements from Tap Hunter on the Raleigh Beer Garden website
	 * 
